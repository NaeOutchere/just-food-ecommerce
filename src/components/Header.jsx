...
import Avatar from '../img/newavatar.png';
        ...
        <header className='fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16'>
            ...
            <div className='hidden md:flex w-full h-full items-center justify-between'>
                <Link to={"/"} className='flex items-center gap-2'>
                    ...
                    <p className='text-headingColor text-xl font-bold'>Just Food</p>
                </Link>
                ...
                <div className='flex items-center gap-8'>
                    ...
                    <div className='relative'>
                        <motion.img
                            ...
                            className='w-8 min-w-[30px] h-8 min-h-[30px] drop-shadow-xl cursor-pointer rounded-full' alt="userprofile"
                            onClick={login}
                        />
                        {isMenu && (
                            <motion.div
                                initial={{ opacity: 0, scalec: 0.6 }}
                                animate={{ opacity: 1, scalec: 1 }}
                                exit={{ opacity: 0, scalec: 0.6 }}
                                className='w-40 bg-gray-50 shadow-xl rounded-lg flex flex-col absolute top-12 right-0'>
                                {user && user.email === "dnrose35@gmail.com" && (
                                    <Link to={"/createItem"}>
                                        <p
